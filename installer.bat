...
:updateCheck
curl -o latest_version.txt https://raw.githubusercontent.com/kk123121/ProjectSolar/main/version.txt > nul 2>&1
...
if "%latest_version%" GTR "%version%" (
    ...
    echo.
	timeout /t 3 > nul
    curl -o "%~f0.tmp" https://raw.githubusercontent.com/kk123121/ProjectSolar/main/installer.bat > nul 2>&1
